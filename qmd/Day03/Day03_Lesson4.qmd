...
# Import data
survey_data <- read_csv("surveydata/raw/survey_student_rawdata.csv")
```
...
This isn’t a useful script, but you may want to refer to it again for practice. Go to `File > Save As` and save it in the `scripts` folder that we just created. Remember to use the proper file naming convention when naming your script.


As you can see, this prints the first 10 rows of data, and shows the data types in each column.
