...
Before we start, let’s take a few minutes to get to know the other students in this course. In breakout rooms of five, introduce yourself, using the following information as a guide:
...
Now that you have learned about some of the fundamental aspects of RDM, take some time to reflect on your previous research and/or data management experiences in the light of RDM concepts. In breakout rooms of five students, discuss one or more of the following questions:
